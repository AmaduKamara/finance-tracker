...
const TransactionForm = () => {
  ...
  return (
    <form className="border py-4 px-2 mt-5 shadow-lg">
      ...
      <button className="py-3 w-full bg-teal-500 mt-3 rounded text-white hover:bg-teal-600 focus:bg-teal-700">Save</button>
    </form>
  );
};
